...
public static class HexMetrics {
    ...
    public static Vector3 GetSecondCorner(this HexDirection direction)
    {
        return corners[(int)direction + 1];
    }

    public static Vector3 GetFirstSolidCorner(this HexDirection direction)
    {
        return corners[(int)direction] * solidFactor;
    }

    public static Vector3 GetSecondSolidCorner(this HexDirection direction)
    {
