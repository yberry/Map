...
public class HexGridChunk : MonoBehaviour {
    ...
    void Triangulate(HexDirection direction, HexCell cell)
    {
        ...
        EdgeVertices e = new EdgeVertices(
            center + direction.GetFirstSolidCorner(),
            center + direction.GetSecondSolidCorner()
        );
    ...
    void TriangulateConnection(HexDirection direction, HexCell cell, EdgeVertices e1)
    {
        ...
        Vector3 bridge = direction.GetBridge();
        ...
        {
            TriangulateEdgeStrip(e1, color1, cell.TerrainTypeIndex, e2, color1, neighbor.TerrainTypeIndex, hasRoad);
        }
        ...
        {
            Vector3 v5 = e1.v5 + direction.Next().GetBridge();
    ...
    void TriangulateWithRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        {
            centerL = center + direction.Previous().GetFirstSolidCorner() * 0.25f;
            centerR = center + direction.Next().GetSecondSolidCorner() * 0.25f;
        }
        ...
        {
            centerL = center;
            centerR = center + direction.Next().GetSolidEdgeMiddle() * (0.5f * HexMetrics.innerToOuter);
        }
        else
        {
            centerL = center + direction.Previous().GetSolidEdgeMiddle() * (0.5f * HexMetrics.innerToOuter);
            centerR = center;
        }
    ...
    void TriangulateAdjacentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        if (cell.HasRiverThroughEdge(direction.Next()))
        {
            ...
            {
                center += direction.GetSolidEdgeMiddle() * (HexMetrics.innerToOuter * 0.5f);
            }
            else if (cell.HasRiverThroughEdge(direction.Previous2()))
            {
                center += direction.GetFirstSolidCorner() * 0.25f;
            }
        }
        else if (cell.HasRiverThroughEdge(direction.Previous()) && cell.HasRiverThroughEdge(direction.Next2()))
        {
            center += direction.GetSecondSolidCorner() * 0.25f;
        }
    ...
    void TriangulateRoadAdjacentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        if (cell.HasRiverBeginOrEnd)
        {
            roadCenter += cell.RiverBeginOrEndDirection.Opposite().GetSolidEdgeMiddle() * (1f / 3f);
        }
        else if (cell.IncomingRiver == cell.OutgoingRiver.Opposite())
        {
            ...
            if (previousHasRiver)
            {
                ...
                corner = direction.GetSecondSolidCorner();
            }
            else
            {
                ...
                corner = direction.GetFirstSolidCorner();
            }
        ...
        {
            roadCenter -= cell.IncomingRiver.GetSecondCorner() * 0.2f;
        }
        else if (cell.IncomingRiver == cell.OutgoingRiver.Next())
        {
            roadCenter -= cell.IncomingRiver.GetFirstCorner() * 0.2f;
        }
        else if (previousHasRiver && nextHasRiver)
        {
            ...
            Vector3 offset = direction.GetSolidEdgeMiddle() * HexMetrics.innerToOuter;
        ...
        else
        {
            ...
            Vector3 offset = middle.GetSolidEdgeMiddle();
